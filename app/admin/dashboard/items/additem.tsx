    ...
    return (
        <Popup
            ...
            <Page className=' k-color-brand-primary'>
                ...
                <form onSubmit={onSubmit} className="flex flex-col gap-2 p-4 h-[calc(100%-64px)] relative">
                    <ImageInput accept="image/*" name="image" />
                    <div className="flex flex-col gap-2 mt-2 pb-5-safe ">
                        <Input
                            label="Name"
                            name="name"
                    ...
                    <div className="w-full absolute inset-x-0 bottom-0 p-2">
                        <Button
