    ...
    return (
        <div className="flex justify-center col-span-full h-[calc(100%-300px)] w-full p-4">
            ...
            >
                ...
                ></path>
                <circle cx="336.978" cy="450.704" r="42.012" fill="#372e1c"></circle>
                <path
                    fill="#372e1c"
                    d="M565.937 563.554H588.8050000000001V576.317H565.937z"
                ...
                <path
                    fill="#372e1c"
                    d="M617.672 558.502H630.4350000000001V581.37H617.672z"
                ...
                <path
                    fill="#372e1c"
                    d="M553.707 710.302H566.7909999999999V733.744H553.707z"
                ></path>
                <path
                    fill="#372e1c"
                    d="M527.54 710.302H540.6239999999999V733.744H527.54z"
                ></path>
                <ellipse
                    cx="555.888"
                    cy="734.016"
                ...
                <circle cx="536.222" cy="662.268" r="4.786" fill="#372e1c"></circle>
